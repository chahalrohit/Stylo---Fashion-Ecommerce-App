...
import { SafeAreaView, View, Image, StatusBar, ScrollView, TextInput, StyleSheet, Text } from "react-native";
            ...
            <View style={styles.headerWrapStyle}>
                <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <TextInput
                        ...
                        style={{ marginLeft: Sizes.fixPadding, flex: 1, ...Fonts.grayColor14Medium }}
                    />
                </View>
                <MaterialIcons
                    name="search"
