...
import { SafeAreaView, Animated, Image, TouchableOpacity, Dimensions, View, StatusBar, StyleSheet, Text } from "react-native";
    ...
    function totalPriceAndPayButton() {
        return (
            <View style={{
                ...
                <TouchableOpacity
                    activeOpacity={0.9}
                    onPress={() => listData.length != 0 ? navigation.push('Delivery') : null}
                    style={{
