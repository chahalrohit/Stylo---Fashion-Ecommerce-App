...
import { BackHandler, SafeAreaView, TouchableOpacity, ScrollView, TextInput, View, StatusBar, Image, StyleSheet, Text } from "react-native";
        ...
        return (
            <Text
                ...
                style={{
                    ...
                    textAlign: 'center', ...Fonts.blackColor16Bold
                }}
            >
                FORGOT PASSWORD?
            </Text>
        ...
        return (
            <View style={styles.textFieldWrapStyle}>
                ...
                <TextInput
                    ...
                    style={{ flex: 1, marginLeft: Sizes.fixPadding, ...Fonts.blackColor15Medium }}
