...
import { SafeAreaView, View, Dimensions, ScrollView, StatusBar, Image, TouchableOpacity, StyleSheet, Text } from "react-native";
                        ...
                        <View style={styles.paymentOptionsWrapStyle}>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <View style={{
                                    ...
                                    borderColor: selectedPaymentMethodId == item.id ? Colors.blueColor : Colors.lightGrayColor,
                                }}>
                                    {
