...
import { SafeAreaView, Dimensions, View, TouchableWithoutFeedback, TouchableOpacity, FlatList, Image, StatusBar, StyleSheet, Text } from "react-native";
...
const sortingCategoriesList = ['Popularity', 'Price -- Low to High', 'Price -- High to Low', 'Newest First'];
...
const ProductsScreen = ({ navigation }) => {
    ...
    const [selectedProductCategory, setSelectedProductCategory] = useState(productCategoriesList[0].productCategory);
    ...
    function productSortBySheet() {
        return (
            <BottomSheet
                ...
                modalProps={{ onRequestClose: () => { setShowSortBottomSheet(false) }, }}
            >
                                        ...
                                        <View key={`${index}`}>
                                            ...
                                            >
                                                <View style={{
                                                    ...
                                                    borderColor: currentSortingCriteria == item ? Colors.blueColor : Colors.lightGrayColor,
                                                }}>
                                                    {
                                                ...
                                                <Text style={{ marginLeft: Sizes.fixPadding + 5.0, ...Fonts.blackColor15Medium }}>
                                                    {item}
                                                </Text>
                                            </TouchableOpacity>
                                        </View>
    ...
    function productsCategories() {
        ...
        const renderItem = ({ item }) => (
            <TouchableOpacity
                ...
                style={{
                    borderColor: selectedProductCategory == item.productCategory ? Colors.primaryColor : Colors.lightGrayColor,
                    ...styles.productCategoriesWrapStyle
                }}
            >
                <Text style={selectedProductCategory == item.productCategory ? { ...Fonts.primaryColor15SemiBold } : { ...Fonts.blackColor15Medium }}>
